    ...
    def cargar_archivo(self, nombre_archivo):
        with open(nombre_archivo, 'r') as archivo:
            for linea in archivo:
                fecha_str, temp_str = linea.strip().split(';')
...
db.cargar_archivo('proyecto_2/docs/muestras.txt')
...
fecha_inicio = "04/01/2025"
fecha_fin = "09/01/2025"
...
db.borrar_temperatura("08/01/2025")
db.borrar_temperatura("04/01/2025")
