class monticulo():
    ...
    def construirMonticulo(self, unaLista, param1=None, param2=None): # Crea un montículo a partir de una lista de elementos
        i = len(unaLista) // 2
        self.tam = len(unaLista)
        self.lista = [None] + unaLista[:]
        while (i > 0):
            self.infiltAbajo(i, param1, param2) # Infiltra hacia abajo cada elemento desde la mitad de la lista
            i = i - 1
