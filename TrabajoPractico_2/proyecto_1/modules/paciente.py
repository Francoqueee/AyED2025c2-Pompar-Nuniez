...
nombres = ['Mia', 'Fran', 'Maxi', 'Colo', 'Tito', 'Santi', 'Juli', 'Mari', 'Luci', 'Nati']
apellidos = ['France', 'Pompar', 'Nuñez', 'Colman', 'Brehm', 'Maidana', 'Saravia', 'Vela', 'Micheloud', 'Almiron']
...
class Paciente:
    ...
    def __str__(self):
        ...
        cad += '\t (llegada: ' + self.__llegada.strftime('%H:%M:%S') + ')'
        return cad
